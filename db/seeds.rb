...
Plant.create!(name: 'Aloe Vera', img_url: '', details: 'Aloe vera are easy to maintain which has a high popularity in having them whether indoor or outdoor. Aloe vera is grown for both medicinal and agricultural reasons as well for decorative purposes. ',
  care: 'Easy', water: 'Every 2 - 3 weeks', sun: 'Full direct to medium sunlight', toxicity: 'false')
Plant.create!(name: 'Golden Pothos', img_url: '', details: 'Golden pothos are native to South Asia. The golden pothos loves to climb and latch on to areas with the aerial rootlets. On larger vines the leaves are able to grow to 30" long. Golden pothos are also beleived to be an air purifier.',
  care: 'Easy', water: '1 - 2 per week', sun: 'Medium to bright indirect sunlight', toxicity: 'true')
Plant.create!(name: 'Lucky Bamboo', img_url: '', details: 'The Lucky bamboo or Dracena sanderiana are originally native to Africa. Lucky bamboo known to create the sense of balance and safety in life. Also, believed to bring good lick and fortune to those who own them. Lucky bamboo are able to be potted in a water and rocks, as long as these are well taken care of and the water is not fresh tap water.',
  care: 'Easy', water: 'Potted in distilled water', sun: 'Bright indirect sunlight', toxicity: 'false')
Plant.create!(name: 'Sansevieria Trifasciata Black Dragon', img_url: '', details: 'Sansevieria trifasciata black dragon species is native to the tropical area of Africa. As a snake plant, the black dragon, are on the top of the list of air purifying plants.',
...
@potho = Potho.create!(name: 'Golden Pothos', img_url: '', details: 'Golden pothos are native to South Asia. The golden pothos loves to climb and latch on to areas with the aerial rootlets. On larger vines the leaves are able to grow to 30" long. Golden pothos are also beleived to be an air purifier.',
  care: 'Easy', water: '1 - 2 per week', sun: 'Medium to bright indirect sunlight', toxicity: 'true')
# Potho.create!(name: 'Marble Queen Pothos', img_url: '', details: '', care: '', water: '', sun: '', toxicity: 'true')
# Potho.create!(name: 'Neon Pothos', img_url: '', details: '', care: '', water: '', sun: '', toxicity: 'true')
# Potho.create!(name: 'Manjula Pothos', img_url: '', details: '', care: '', water: '', sun: '', toxicity: 'true')
